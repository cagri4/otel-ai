/**
 * Cron route handler for trial countdown notification dispatch.
 *
 * Fires daily at 09:00 UTC (configured in vercel.json) — after milestone-dispatch
 * (06:00 UTC) and housekeeping-queue (07:00 UTC).
...
import { runTrialNotificationDispatch } from '@/lib/cron/trialNotification';
